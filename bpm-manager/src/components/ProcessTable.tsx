                        ...
                        {processes.length === 0 ? (
                            ...
                            paginatedProcesses.map((process) => {
                                ...
                                return (
                                    <tr
                                        key={process.id}
                                        onClick={() => onView && onView(process.id)}
                                        className={`group transition-all ${!isAuthorized ? 'opacity-70 bg-slate-50/50 dark:bg-slate-900/50' : 'hover:bg-slate-50 dark:hover:bg-slate-800'} ${onView ? 'cursor-pointer' : ''}`}
                                    >
                                        ...
                                        <td className="px-3 py-2.5">
                                            <div className="flex justify-start items-center gap-1.5">
                                                ...
                                                {process.status === 'active' ? (
                                                    <button
                                                        onClick={(e) => { e.stopPropagation(); isAuthorized && onAttend?.(process.id); }}
